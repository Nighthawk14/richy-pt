...
function ow_option_element( $name, $attr_option, $type, $shortcode )
{
	$option_element = null;
	...
	switch( $attr_option['type'] )
	{
		...
		case 'custom':
			if( $name == 'progressbar' )
			{
				...
				<a href="#" class="btn yellow remove-list-item">'.__('Remove', 'ulysses' ). '</a> 
				<a href="#" class="btn yellow add-list-item">'.__('Add', 'ulysses' ).'</a>';
			} 
			elseif( $name == 'social' )
			{
				$option_element .= '
			...
			elseif( $name == 'column' )
			{
				...
				<div class="shortcode-dynamic-items" id="options-item" data-name="item">
					<div class="shortcode-dynamic-item">
						...
						<div class="label"><label><strong> Heading: </strong></label></div>
						<div class="content"><input class="shortcode-dynamic-item-text-heading" type="text" name="" /></div>
				...
				<a href="#" class="btn yellow remove-list-item">'.__('Remove Column', 'ulysses' ). '</a> <a href="#" class="btn yellow add-list-item">'.__('Add Column', 'ulysses' ).'</a>';
			} 
			elseif( $name == 'accordion' )
			{
				...
				<div class="shortcode-dynamic-items" id="options-item" data-name="item">
					<div class="shortcode-dynamic-item">
						...
						<div class="content">
							<input class="shortcode-dynamic-item-text-title" type="text" name="" />
						</div>
						<div class="label"><label><strong> Content: </strong></label></div>
						<div class="content"><textarea class="shortcode-dynamic-item-text" type="text" name="" /></textarea></div>
					</div>
				</div>
				<a href="#" class="btn yellow remove-list-item">'.__('Remove accordion', 'ulysses' ). '</a> <a href="#" class="btn yellow add-list-item">'.__('Add accordion', 'ulysses' ).'</a>';
			} 			
			elseif( $name == 'image' )
			{
				$option_element .= '
				...
				<a data-update="Select File" data-choose="Choose a File" href="javascript:void(0);"class="redux-opts-upload button-secondary" rel-id="">' . __('Upload', 'ulysses') . '</a>
				<a href="javascript:void(0);" class="redux-opts-upload-remove" style="display: none;">' . __('Remove Upload', 'ulysses') . '</a>';
