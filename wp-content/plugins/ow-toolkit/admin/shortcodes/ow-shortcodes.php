...
// Shortcodes Definitionsrequire_once( 'generate-shortcode.php' );// Shortcode html$html_options = null;$shortcode_html = '<div id="shortcode-generator">
    <div class="shortcode-content">
        <div class="label"><strong>Ulysses Shortcodes</strong></div>
        <div class="content">
			<select id="ow-shortcodes" data-placeholder="' . __("Choose a shortcode", 'ulysses') .'">
