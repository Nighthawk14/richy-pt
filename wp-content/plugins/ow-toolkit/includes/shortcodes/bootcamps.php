...
function ulysses_bootcamp( $atts )
{
	...
	if( '' === $section_id ) :
		$section_id = __('bootcamp','ulysses');
	endif;
	...
	<div class="classes-section" id="<?php echo esc_attr( $section_id ); ?>">
		...
		<div id="classes-slider" class="flexslider classes-slider bootcamp-slider">
					...
					<li class="slide">
						<div class="slide-text">
							...
							<div class="box-2 d-bg-c">
								<ul>
									<li class="i-1"><?php echo  $classes_timing ; ?></li>
...
add_shortcode('ulysses_bootcamp', 'ulysses_bootcamp');
?>